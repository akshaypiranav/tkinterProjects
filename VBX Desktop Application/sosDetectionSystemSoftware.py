...
sosHardwareTitle=Label(text="𝚂𝙾𝚂 𝙴𝙼𝙴𝚁𝙶𝙴𝙽𝙲𝚈 𝙰𝙻𝙴𝚁𝚃 𝚂𝙾𝙵𝚃𝚆𝙰𝚁𝙴",bg="black",fg="#cccccc",font="BOLD").place(x=140,y=15)
...
#DESCRIPTION
sosHardwareDescription=Label(text="""SOS SOFTWARE MEANS A SOFTWARE PLACED IN CAR
IF YOU PRESSED THAT IT SENDS MESSAGE TO THE 100""",bg="black",fg="#cccccc",font="BOLD").place(x=25,y=70)
